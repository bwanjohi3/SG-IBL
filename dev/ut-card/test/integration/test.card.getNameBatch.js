...
const PRODUCTNAME = 'gnb' + cardConstants.PRODUCTNAME;
const USERNAME = 'gnb' + userConstants.USERNAME;
...
const BIN1 = parseInt('38' + commonFunc.generateRandomFixedInteger(4));
