...
const PRODUCTNAME = 'rsa' + cardConstants.PRODUCTNAME;
const USERNAME = 'rsa' + userConstants.USERNAME;
...
const BIN1 = parseInt('48' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Reject save status update application',
        server: opt.server,
