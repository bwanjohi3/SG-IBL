...
const PRODUCTNAME = 'ua' + cardConstants.PRODUCTNAME;
const USERNAME = 'ua' + userConstants.USERNAME;
...
const BIN1 = parseInt('54' + commonFunc.generateRandomFixedInteger(4));
        ...
        steps: function(test, bus, run) {
            ...
            // customerMethods.getByDepthOrganization('get organizations by depth', context => GETBYDEPTHORGANIZATION),
                ...
                cardMethods.updateApplicationState('update application - change targetBranchId', context => {
                    return {
                        application: {
                            ...
                            productId: context['add product successfully'].cardProduct[0].productId,
                            typeId: typeIdOwn,
                            targetBranchId: context['add organization child of main org']['organization.info'][0].actorId,
                            batchId: null,
                            customerId: null
                        },
                        account: [{
                ...
                commonFunc.createStep('card.application.get', 'get updated person and customer names', context => {
                    ...
                    assert.equals(result.application[0].personName, customerConstants.FIRSTNAME + ' ' + customerConstants.LASTNAME, 'return updated personName');
                    assert.equals(result.application[0].customerName, customerConstants.FIRSTNAME + ' ' + customerConstants.LASTNAME, 'return updated customerName');
                }),
                ...
                commonFunc.createStep('card.application.statusUpdate', 'update with second account', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                ...
                commonFunc.createStep('card.application.get', 'get updated account', context => {
                    return {
                        applicationId: context['add application'].cardApplication[0].applicationId
                    };
                }, (result, assert) => {
                ...
                commonFunc.createStep('card.application.statusUpdate', 'two primary accounts', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                        ...
                        account: [{
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            applicationAccountId: context['get updated account'].accounts.find(account => account.isLinked === 1).applicationAccountId,
                            accountNumber: ACCOUNTNUMBER,
                            accountOrder: ACCOUNTORDER,
                            accountTypeName: ACCOUNTNAME,
                            accountLinkId: ACCOUNTLINKID,
                        ...
                        {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            applicationAccountId: context['get updated account'].accounts.find(account => account.accountOrder === ACCOUNTORDER + 1).applicationAccountId,
                            accountNumber: ACCOUNTNUMBER + 1,
                            accountOrder: ACCOUNTORDER + 1,
                            accountTypeName: ACCOUNTNAME,
                            accountLinkId: ACCOUNTLINKID,
                ...
                commonFunc.createStep('card.application.statusUpdate', 'same account order', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                        ...
                        account: [{
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            applicationAccountId: context['get updated account'].accounts.find(account => account.accountOrder === ACCOUNTORDER).applicationAccountId,
                            accountNumber: ACCOUNTNUMBER,
                            accountOrder: ACCOUNTORDER,
                            accountTypeName: ACCOUNTNAME,
                            accountLinkId: ACCOUNTLINKID,
                ...
                commonFunc.createStep('card.application.statusUpdate', 'change isPrimary', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                ...
                commonFunc.createStep('card.application.get', 'get updated isPrimary', context => {
                    return {
                        applicationId: context['add application'].cardApplication[0].applicationId
                    };
                }, (result, assert) => {
                ...
                commonFunc.createStep('card.application.statusUpdate', 'change order', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                ...
                commonFunc.createStep('card.application.get', 'get updated account order', context => {
                    return {
                        applicationId: context['add application'].cardApplication[0].applicationId
                    };
                }, (result, assert) => {
                ...
                commonFunc.createStep('card.application.statusUpdate', 'remove primary account', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                ...
                commonFunc.createStep('card.application.statusUpdate', 'remove primary account and order doesnt start from 1', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                ...
                cardMethods.updateApplicationState('remove account', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber,
                ...
                commonFunc.createStep('card.application.get', 'get updated account count', context => {
                    return {
                        applicationId: context['add application'].cardApplication[0].applicationId
                    };
                }, (result, assert) => {
                ...
                commonFunc.createStep('card.application.statusUpdate', 'change customerNumber', context => {
                    return {
                        application: {
                            applicationId: context['add application'].cardApplication[0].applicationId,
                            customerNumber: context['add customer'].customer.customerNumber + 2,
                            issuingBranchId: context['add application'].cardApplication[0].issuingBranchId,
                            holderName: cardConstants.HOLDERNAME + '1',
                            personNumber: context['add customer'].customer.actorId,
                            customerName: customerConstants.FIRSTNAME + ' ' + customerConstants.LASTNAME + 'Update',
                ...
                commonFunc.createStep('card.application.statusUpdate', 'edit approved application', context => {
                    return {
                        application: {
                            ...
                            customerNumber: context['add customer'].customer.customerNumber,
                            issuingBranchId: context['add application'].cardApplication[0].issuingBranchId,
                            holderName: cardConstants.HOLDERNAME + '2',
                            personNumber: context['add customer'].customer.actorId,
                            productId: context['add product successfully'].cardProduct[0].productId,
                            typeId: typeIdOwn,
                            reasonId: context['add application'].cardApplication[0].reasonId,
                ...
                (error, assert) => {
                    assert.equals(error.type, 'portSQL', 'return joi failure');
                }),
                ...
                //             holderName: cardConstants.HOLDERNAME + '1',
                //             personName: customerConstants.FIRSTNAME + ' ' + customerConstants.LASTNAME + 'Update',
                //             personNumber: context['add customer'].customer.customerNumber,
                //             productId: context['add product successfully'].cardProduct[0].productId,
                // typeId: typeIdOwn,
                //             targetBranchId: context['add customer'].customer.organizationId
                //         },
