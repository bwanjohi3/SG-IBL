...
const PRODUCTNAME = 'acbas' + cardConstants.PRODUCTNAME;
const USERNAME = 'acbas' + userConstants.USERNAME;
...
const BIN1 = parseInt('20' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Approve create batch status update application from service',
        server: opt.server,
