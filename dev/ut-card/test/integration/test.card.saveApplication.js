...
const PRODUCTNAME = 'sa' + cardConstants.PRODUCTNAME;
const USERNAME = 'sa' + userConstants.USERNAME;
...
const BIN1 = parseInt('50' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Approved status update application - save application',
        server: opt.server,
