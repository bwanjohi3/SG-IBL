...
const PRODUCTNAME = 'appras' + cardConstants.PRODUCTNAME;
const USERNAME = 'appras' + userConstants.USERNAME;
...
const BIN1 = parseInt('25' + commonFunc.generateRandomFixedInteger(4));
