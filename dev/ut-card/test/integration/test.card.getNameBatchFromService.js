...
const PRODUCTNAME = 'gnbs' + cardConstants.PRODUCTNAME;
const USERNAME = 'gnbs' + userConstants.USERNAME;
...
const BIN1 = parseInt('39' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'get name Batch from service',
        server: opt.server,
