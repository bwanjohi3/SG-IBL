...
const PRODUCTNAME = 'sas' + cardConstants.PRODUCTNAME;
const USERNAME = 'sas' + userConstants.USERNAME;
...
const BIN1 = parseInt('51' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'save application from service',
        server: opt.server,
