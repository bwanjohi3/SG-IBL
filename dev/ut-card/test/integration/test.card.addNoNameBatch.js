...
const USERNAME = 'anb' + userConstants.USERNAME;
const PERMISSION = 'card.batch.addNoNameBatch';
const NUMBEROFCARDS = 12;
const BATCHNAME = cardConstants.NONAMEBATCH;
const TYPEOWN = 'own';
const NAME = cardConstants.RANDOMNAME;
const BIN1 = parseInt('14' + commonFunc.generateRandomFixedInteger(4));
    ...
    test({
        ...
        steps: function(test, bus, run) {
            return run(test, bus, [userMethods.login('login', userConstants.ADMINUSERNAME, userConstants.ADMINPASSWORD, userConstants.TIMEZONE),
                ...
                commonFunc.createStep('card.batch.addNoNameBatch', 'duplicated batchName', context => {
                    return {
                        batch: {
                            batchName: BATCHNAME,
                ...
                // commonFunc.createStep('card.batch.addNoNameBatch', 'missing batchName', context => {
                //     return {
                //         batch: {
                //             numberOfCards: NUMBEROFCARDS,
                //             typeId: typeIdOwn,
                ...
                // }),
                commonFunc.createStep('card.batch.addNoNameBatch', 'missing numberOfCards', context => {
                    return {
                        batch: {
                            batchName: cardConstants.NONAMEBATCH,
                            typeId: typeIdOwn,
                            targetBranchId: context['get admin details'].memberOF[0].object,
                            issuingBranchId: context['get admin details'].memberOF[0].object
                        }
                ...
                commonFunc.createStep('card.batch.addNoNameBatch', 'missing typeId', context => {
                    return {
                        batch: {
                            numberOfCards: NUMBEROFCARDS,
                            batchName: cardConstants.NONAMEBATCH,
                ...
                commonFunc.createStep('card.batch.addNoNameBatch', 'missing targetBranchId', context => {
                    return {
                        batch: {
                            numberOfCards: NUMBEROFCARDS,
                            batchName: cardConstants.NONAMEBATCH,
                ...
                // commonFunc.createStep('card.batch.addNoNameBatch', 'empty string batchName', context => {
                //     return {
                //         batch: {
                //             numberOfCards: NUMBEROFCARDS,
                //             batchName: '',
                ...
                //     assert.equals(error.type, 'PortHTTP', 'return joi failure');
                // }),
                commonFunc.createStep('card.batch.addNoNameBatch', 'empty string numberOfCards', context => {
                    return {
                        batch: {
                            numberOfCards: '',
                            batchName: cardConstants.NONAMEBATCH,
                ...
                commonFunc.createStep('card.batch.addNoNameBatch', 'empty string typeId', context => {
                    return {
                        batch: {
                            numberOfCards: NUMBEROFCARDS,
                            batchName: cardConstants.NONAMEBATCH,
                ...
                commonFunc.createStep('card.batch.addNoNameBatch', 'empty string targetBranchId', context => {
                    return {
                        batch: {
                            numberOfCards: NUMBEROFCARDS,
                            batchName: cardConstants.NONAMEBATCH,
                ...
                commonFunc.createStep('card.batch.addNoNameBatch', 'non existing typeId', context => {
                    return {
                        batch: {
                            numberOfCards: NUMBEROFCARDS,
                            batchName: cardConstants.NONAMEBATCH,
                            typeId: context['get admin details'].memberOF[0].object,
                            targetBranchId: context['get admin details'].memberOF[0].object,
                            issuingBranchId: context['get admin details'].memberOF[0].object
                        }
                    };
                ...
                commonFunc.createStep('card.batch.addNoNameBatch', 'non existing targetBranchId', context => {
                    return {
                        batch: {
                            numberOfCards: NUMBEROFCARDS,
                            batchName: cardConstants.NONAMEBATCH,
                            typeId: typeIdOwn,
                            targetBranchId: typeIdOwn,
                            issuingBranchId: context['get admin details'].memberOF[0].object
                        }
                    };
                }, null,
                ...
                // commonFunc.createStep('card.batch.addNoNameBatch', 'missing permission', context => {
                //     return {
                //         batch: {
                //             batchName: cardConstants.NONAMEBATCH,
                //             numberOfCards: NUMBEROFCARDS,
