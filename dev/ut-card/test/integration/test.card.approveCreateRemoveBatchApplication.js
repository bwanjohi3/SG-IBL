...
const PRODUCTNAME = 'acrba' + cardConstants.PRODUCTNAME;
const USERNAME = 'acrba' + userConstants.USERNAME;
...
const BIN1 = parseInt('21' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Remove From Batch status update application',
        server: opt.server,
