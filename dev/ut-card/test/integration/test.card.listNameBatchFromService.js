...
const PRODUCTNAME = 'lnbs' + cardConstants.PRODUCTNAME;
const TEST1 = cardConstants.TEST1;
const USERNAME = 'lnbs' + userConstants.USERNAME;
...
const BIN1 = parseInt('42' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'list name Batch from service',
        server: opt.server,
