...
const PRODUCTNAME = 'appads' + cardConstants.PRODUCTNAME;
const USERNAME = 'appads' + userConstants.USERNAME;
...
const BIN1 = parseInt('24' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Approve decline status update application from service',
        server: opt.server,
