...
const PRODUCTNAME = 'ra' + cardConstants.PRODUCTNAME;
const USERNAME = 'ra' + userConstants.USERNAME;
...
const BIN1 = parseInt('44' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Rejected status update application',
        server: opt.server,
