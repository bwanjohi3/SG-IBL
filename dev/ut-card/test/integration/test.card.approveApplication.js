...
const PRODUCTNAME = 'appa' + cardConstants.PRODUCTNAME;
const USERNAME = 'appa' + userConstants.USERNAME;
...
const BIN1 = parseInt('17' + commonFunc.generateRandomFixedInteger(4));
