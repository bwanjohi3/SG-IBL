...
const PRODUCTNAME = 'das' + cardConstants.PRODUCTNAME;
const USERNAME = 'das' + userConstants.USERNAME;
...
const BIN1 = parseInt('27' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'decline status update application from service',
        server: opt.server,
