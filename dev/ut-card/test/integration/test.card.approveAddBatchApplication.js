...
const PRODUCTNAME = 'aaba' + cardConstants.PRODUCTNAME;
const CUSTOMERNAME = 'AUTOMATIONTEST' + commonFunc.generateRandomNumber().toString();
const USERNAME = 'aaba' + userConstants.USERNAME;
...
const BIN1 = parseInt('15' + commonFunc.generateRandomFixedInteger(4));
...
var stdPolicy, batchId, embosedTypeIdName, customerTypeId;
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Approve add to batch status update application',
        server: opt.server,
