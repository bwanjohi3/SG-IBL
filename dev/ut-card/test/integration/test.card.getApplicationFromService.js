...
const PRODUCTNAME = 'gas' + cardConstants.PRODUCTNAME;
const USERNAME = 'gas' + userConstants.USERNAME;
...
const BIN1 = parseInt('36' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'get application from service',
        server: opt.server,
