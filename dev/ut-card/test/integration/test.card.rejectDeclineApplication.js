...
const PRODUCTNAME = 'rda' + cardConstants.PRODUCTNAME;
const USERNAME = 'rda' + userConstants.USERNAME;
...
const BIN1 = parseInt('46' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Reject decline status update application',
        server: opt.server,
