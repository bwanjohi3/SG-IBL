...
const PRODUCTNAME = 'ras' + cardConstants.PRODUCTNAME;
const USERNAME = 'ras' + userConstants.USERNAME;
...
const BIN1 = parseInt('45' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Rejected status update application from service',
        server: opt.server,
