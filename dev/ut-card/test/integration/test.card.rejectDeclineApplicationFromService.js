...
const PRODUCTNAME = 'rdas' + cardConstants.PRODUCTNAME;
const USERNAME = 'rdas' + userConstants.USERNAME;
...
const BIN1 = parseInt('47' + commonFunc.generateRandomFixedInteger(4));
...
module.exports = function(opt, cache) {
    test({
        type: 'integration',
        name: 'Reject decline status update application from service',
        server: opt.server,
