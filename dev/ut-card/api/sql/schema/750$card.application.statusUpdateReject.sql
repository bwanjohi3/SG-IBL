create procedure [card].[application.statusUpdateReject] -- executed when application status is rejected - inserts reason Id and comments in table [card].[application]
