...
export const atmTerminalGridPagination = (state = fromJS(defaultState), action) => {
    switch (action.type) {
        ...
        case FETCH:
            if (action.methodRequestState === 'requested' && !action.params.atmId) {
                action.params = {
                    ...action.params,
                    ...{
            ...
            } else if (action.methodRequestState === 'finished' && !action.params.atmId && action.result) {
