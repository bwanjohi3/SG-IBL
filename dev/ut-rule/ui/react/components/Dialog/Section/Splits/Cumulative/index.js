            ...
            <tr key={index}>
                <td>
                    <Input
                      ...
                      value={'' + (isNaN(data[index].dailyCount) ? '' : data[index].dailyCount)}
                    />
                </td>
                <td>
                    <Input
                      ...
                      keyProp='dailyAmount'
                      onChange={this.onChangeInput(index)}
                      value={'' + (isNaN(data[index].dailyAmount) ? '' : data[index].dailyAmount)}
                    />
                </td>
                <td>
                    <Input
                      ...
                      keyProp='weeklyCount'
                      onChange={this.onChangeInput(index)}
                      value={'' + (isNaN(data[index].weeklyCount) ? '' : data[index].weeklyCount)}
                    />
                </td>
                <td>
                    <Input
                      ...
                      onChange={this.onChangeInput(index)}
                      value={'' + (isNaN(data[index].weeklyAmount) ? '' : data[index].weeklyAmount)}
                    />
                </td>
                <td>
                    <Input
                      ...
                      onChange={this.onChangeInput(index)}
                      value={'' + (isNaN(data[index].mounthlyCount) ? '' : data[index].mounthlyCount)}
                    />
                </td>
                <td>
                    <Input
                      ...
                      onChange={this.onChangeInput(index)}
                      value={'' + (isNaN(data[index].mounthlyAmount) ? '' : data[index].mounthlyAmount)}
                    />
                </td>
            </tr>
        );
