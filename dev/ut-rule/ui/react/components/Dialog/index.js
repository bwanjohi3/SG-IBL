                ...
                formatedData.split.map(s => {
                    ...
                    identifiers.map(identifier => {
                        ...
                        s.splitCumulative.push({
                            ...
                            dailyCount: parseInt(identifier.startCountDaily) || 0,
                            mounthlyAmount: cumulativeRanges[0].startAmountMonthly,
                            mounthlyCount: parseInt(cumulativeRanges[0].startCountMonthly) || 0,
                            weeklyAmount: cumulativeRanges[0].startAmountWeekly,
                            weeklyCount: parseInt(cumulativeRanges[0].startCountWeekly),
