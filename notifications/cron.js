 ...
 * @constructor
 */
var CronJob = exports.CronJob = function CronJob(callback, interval) {
...
CronJob.prototype._run = function() {
    ...
    self._promise = when.try(self._callback, this).finally(function() {
        self._promise = null;
        if (!self._awaitRun) {
            self._timer = (self._interval > 0 ? setTimeout : setImmediate)(self._next.bind(self), self._interval);
        } else {
