...
DECLARE @reportTransaction BIGINT, @reportTransactionStat BIGINT, @reportTransactionHour BIGINT, @reportTransactionWeek BIGINT, @reportTransactionYear BIGINT, @reportSettle BIGINT, @reportSettleDetails BIGINT
